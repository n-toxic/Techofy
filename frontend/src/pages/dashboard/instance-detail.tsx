...
import {
  ...
  useStopInstance, useRebootInstance, useListInstancePorts, useAddInstancePort, useDeleteInstancePort
...
export default function InstanceDetail() {
  ...
  const { data: ports = [], refetch: refetchPorts } = useListInstancePorts(id);
