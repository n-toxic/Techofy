...
try {
  setBaseUrl("https://backend-backend-three.vercel.app/");
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/dashboard/instances">
        {() => <ProtectedRoute component={Instances} />}
      </Route>
      <Route path="/dashboard/instances/:id">
        {() => <ProtectedRoute component={InstanceDetail} />}
      </Route>
      ...
      <Route path="/dashboard/support/:id">
      ...
      <Route path="/admin/instances">
        {() => <ProtectedRoute component={AdminInstances} adminOnly />}
      </Route>
      <Route path="/admin/server-pool">
        {() => <ProtectedRoute component={AdminServerPool} adminOnly />}
      </Route>
